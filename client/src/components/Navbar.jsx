...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-4'>
        ...
        {/* Logo */}
        <Link to='/'>
            <img className='w-40 sm:w-32 lg:w-60' 
            src={assets.newLogo} alt=''/>
        </Link>
        ...
        <div>
            {
                ...
                <div className='flex items-center gap-2 sm:gap-3'>
                    ...
                    <div className='relative group'>
                        ...
                        <div className='absolute hidden group-hover:block cursor-pointer top-0 right-0 z-10 text-black rounded pt-12'>
